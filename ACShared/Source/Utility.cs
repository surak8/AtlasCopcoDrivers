...
namespace NSAtlasCopcoShared {
	public static class Utility {
		...
		public static void saveWindowBoundsToRegistry(Window w, string key) {
			//if (w!=null)
			saveRegistryValue(key, makeWindowData(w));
		}

		public static string makeWindowData(Window w) {
			if (w!=null)
		...
		public static void saveRegistryValue(string key, string strValue) {
		...
		public static string readRegistryValue(string key, string defaultValue) {
			string ret;
			RegistryKey v = openOrCreateKey(  RegistryHive.CurrentUser);
